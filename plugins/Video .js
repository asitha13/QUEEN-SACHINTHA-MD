...
await conn.sendMessage(from,{video:{url: downloadUrl },mimetype:"video/mp4",caption :"> *⚜️𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 - : 𝐌𝐑 .©ISHAN 𝐎𝐅𝐂 💛*"},{quoted:mek})
                        break;
...
await conn.sendMessage(from,{document:{url: downloadUrlx },mimetype:"video/mp4",fileName: data.title + ".mp4",caption :"> *⚜️𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 - : 𝐌𝐑 .©ISHAN 𝐎𝐅𝐂 💛*"},{quoted:mek})
                        break;
